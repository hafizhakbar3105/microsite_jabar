...
<div class="max-w-7xl mx-auto space-y-8">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
            <h1 class="text-2xl sm:text-3xl font-extrabold text-gray-900 tracking-tight">Statistik & Performa Wisata</h1>
            <p class="text-xs sm:text-sm text-gray-500 font-medium mt-1">Pantau tren kunjungan dan minat wisatawan di microsite Jabar Explore Anda.</p>
        </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
        ...
        <div class="relative overflow-hidden bg-white border border-gray-200/80 rounded-2xl p-6 shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all group">
            <div class="flex items-center justify-between mb-4">
                <span class="text-xs font-bold text-gray-500 uppercase tracking-wider">Total Destinasi & Tautan</span>
            ...
            <div class="flex items-baseline gap-2.5">
                ...
                <span class="inline-flex items-center gap-1 text-xs font-bold text-emerald-800 bg-emerald-100/80 px-2.5 py-0.5 rounded-full border border-emerald-200">
                    <span class="w-1.5 h-1.5 rounded-full bg-emerald-500"></span> {{ $activeLinks }} Tampil
                </span>
            </div>
        </div>
        ...
        <div class="relative overflow-hidden bg-white border border-gray-200/80 rounded-2xl p-6 shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all group">
            <div class="flex items-center justify-between mb-4">
                <span class="text-xs font-bold text-gray-500 uppercase tracking-wider">Total Kunjungan Wisatawan</span>
            ...
            <div class="flex items-baseline">
                ...
                <span class="text-xs font-medium text-gray-400 ml-2">Akses Wisatawan</span>
            </div>
        </div>
        ...
        <div class="relative overflow-hidden bg-white border border-gray-200/80 rounded-2xl p-6 shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all group">
            <div class="flex items-center justify-between mb-4">
                <span class="text-xs font-bold text-gray-500 uppercase tracking-wider">Destinasi Favorit Utama</span>
            ...
            @if($topLink)
                ...
                <span class="inline-flex items-center gap-1.5 text-xs font-bold text-amber-800 bg-amber-50 px-2.5 py-1 rounded-lg border border-amber-200">
                    <i data-lucide="trending-up" class="w-3.5 h-3.5 text-amber-600"></i> {{ number_format($topLink->clicks) }}x Dilihat
                </span>
            @else
                <p class="text-base font-semibold text-gray-400">Belum ada data kunjungan</p>
            @endif
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white border border-gray-200/80 rounded-3xl p-6 shadow-sm">
            <div class="flex items-center justify-between border-b border-gray-100 pb-4 mb-6">
                <div>
                    <h3 class="text-base font-extrabold text-gray-900">5 Destinasi Paling Banyak Dilirik</h3>
                    <p class="text-xs text-gray-500 font-medium">Perbandingan tingkat antusiasme wisatawan pada rekomendasi populer</p>
                </div>
        ...
        <!-- Doughnut Chart (Wisata Favorit) -->
        <div class="bg-white border border-gray-200/80 rounded-3xl p-6 shadow-sm">
            <div class="flex items-center justify-between border-b border-gray-100 pb-4 mb-6">
                <div>
                    <h3 class="text-base font-extrabold text-gray-900">Wisata Favorit yang Dikunjungi</h3>
                    <p class="text-xs text-gray-500 font-medium">Proporsi ketertarikan wisatawan berdasarkan konten yang dibuka</p>
                </div>
                <div class="w-8 h-8 rounded-lg bg-emerald-50 text-jabar-primary flex items-center justify-center">
...
<script>
    ...
    // Palet Warna On-Brand JABAR EXPLORE
